  ...
  return (
	<html lang="en">
		...
		<body className={inter.className}>
			<Navbar />
			{children}
			<a className="redirectwhatsapp" href="https://wa.me/+33771473026" target="_blank">
		  		<svg stroke="white" fill="white" width="24" height="24" viewBox="0 0 24 24">
